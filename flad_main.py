    ...
    if args.clients is not None:
        ...
        for subfolder in subfolders:
            try:
                ...
                X_test, Y_test, time_window, max_flow_len, dataset_name = load_set(subfolder, "test", SEED)
            except Exception as e:
                print("Error loading the dataset: " + str(e))
                continue

            client = init_client(subfolder, X_train, Y_train, X_val, Y_val, dataset_name, time_window, max_flow_len, X_test, Y_test)
